...
class ylowpass : public object<ylowpass>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"YLowpass is soft and smooth to nasty, edgy texture-varying filtering."};
	MIN_TAGS {"filter"};
