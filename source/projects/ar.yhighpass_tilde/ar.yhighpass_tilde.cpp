...
class yhighpass : public object<yhighpass>, public vector_operator<> {
public:
	MIN_DESCRIPTION {"YHighpass is soft and smooth to nasty, edgy texture-varying filtering."};
	MIN_TAGS {"filter"};
